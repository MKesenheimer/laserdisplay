#!/usr/bin/env python3
import LaserDisplay
from LaserDisplay.LaserDisplaySimulator import LaserDisplaySimulator
import math
import pygame
import random
...
if not isinstance(LD, LaserDisplaySimulator):
    # the display backend did not open a window; open a small one so that we
    # can receive keyboard events for controlling the bats
    pygame.init()
    pygame.display.set_mode((360, 80))
    pygame.display.set_caption('pong controls: player1 q/a, player2 o/l, esc quits')
